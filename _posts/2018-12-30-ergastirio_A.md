...
δεύτερη στήλη τον χρόνο σε $$s$$ και τρήτη στήλη το τετράγωνο του χρόνου σε $$s^2$$. Να σχεδιάσεται
...
του Νεύτωνα υπολογίστε την κλίση $$φ$$ του κεκλιμένου επιπέδου. Πόσα βιβλία χρησιμοποίησαν οι 
μαθητές για να κατασκευάσουν το κεκλιμένο επίπεδο;
