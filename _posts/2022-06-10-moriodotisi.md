...
$$P_{ατμ} + \frac{1}{2} ρ_Β υ^2 + ρ g \frac{H}{6} = P_{ατμ} + \frac{1}{2} ρ υ_1^2 + 0 
...
συνεχώς αυξάνεται. Στον αγωγό που πλέον διαρρέεται από επαγωγικό ρεύμα εμφανίζεται δύναμη
Laplace ($F_L = BI_{επ}l = \frac{B E_{επ} l}{R_{ολ}} = \frac{B^2l^2υ}{R_{ολ}}$) και κατεύθυνση
που φαίνεται στο σχήμα. Το μέτρο της δύναμης Laplaceπου αυξάνεται διότι η ταχύτητα αυξάνεται. Η συνισταμένη δύναμη (βάρος + Laplace) ελαττώνεται οπότε η κίνηση
