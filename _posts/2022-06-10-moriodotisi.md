...
$$U_{ελ_{αρχ}} = U_{ελ_{τελ}} \Rightarrow \frac{1}{2} \cdot k \cdot  Δl_{αρχ}^2 = \frac{1}{2} \cdot k \cdot  Δl_{τελ}^2 \Rightarrow  Δl_{αρχ} = Δl_{τελ}$$

Αφού οι ακραίες θέσεις ισαπέχουν από την $Θ.Φ.Μ$ η θέση φυσικού μήκους είναι και θέση ισορροπίας και 
ισχύει $Α_2 = Δl_o$
