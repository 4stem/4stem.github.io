...
$$P_Θ + \frac{1}{2} \cdot ρ \cdot υ_Θ^2 + ρ \cdot g \cdot (H -h_1) = P_O + \frac{1}{2} \cdot ρ \cdot υ_O^2+ 0$$
...
$$Α \cdot \sqrt{2 \cdot g \cdot (H - h_1)} = A \cdot \sqrt{2 \cdot g \cdot H} \Rightarrow 2 \cdot g \cdot (H-h_1) = 2 \cdot g \cdot H $$
