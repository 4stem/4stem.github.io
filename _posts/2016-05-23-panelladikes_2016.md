...
Έστω $$Α$$ το σημείο επαφής του κυλίνδρου με το κεκλιμένο επίπεδο. Θεωρούμε στιγμιαίο άξονα περιστροφής οριζόντιο που διέρχεται από το σημείο Α. Ο κύλινδρος εκτελεί μόνο περιστροφική κίνηση γύρω από τον στιγμιαία άξονα περιστροφής.
...
$$\frac{dK}{dt} = Στ \cdot ω = \frac{3}{2} \cdot M \cdot R^2 \cdot α_{γων}^2 \cdot t \Rightarrow \frac{dK}{dt} = 100 \frac{J}{s}$$


Τα θέματα μπορούν να βρεθούν στο παρακάτω link: http://bit.ly/1XGPDiR