...
**$$Β_4$$** Το κύκλωμα του σχήματος αποτελείται από ιδανική πηγή ηλεκτρεγερτικής δύναμης $$\mathcal{E}$$, δύο αντιστάτες με ωμική αντίσταση $$R_1$$ και $$R_2$$ και ιδανικό πηνίο με συντελεστή αυτεπαγωγής $$L$$. 
