...
$$T_4 \cdot 2 \cdot R_K - M_Κ \cdot g \cdot ημφ \cdot R_Κ = \frac{1}{2} \cdot M_Κ \cdot R_Κ^2 \cdot α_{γων_Δ} \Rightarrow 2\cdot T_4 - 10 =  3 \cdot R_K \cdot α_{γων_Δ} \quad (8) $$
...
και $$W_{K_y}$$ η κάθετη συνιστώσα του βάρους της σανίδας.

$$Στ_{(Γ)} = 0 \Rightarrow N' \cdot (ΩΓ) - W_{K_y} \cdot (ΚΓ) = 0 \Rightarrow M_Κ \cdot g \cdot συνφ \cdot (ΩΓ) - Μ_ρ \cdot g \cdot συνφ \cdot (ΚΓ) $$
...
Αφού $$l < x$$ η ράβδος δεν ανατρέπεται. 
...
Έστω τυχαία θέση του κυλίνδρου για την οποία το σημείο επαφής του κυλίνδρου με την σανίδα έχει απομάκρυνση $$x$$ από την θέση $$Δ$$
