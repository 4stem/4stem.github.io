...
<div align = "right"><span style="font-size: 250%; color: #916FFF;">&#9313;</span></div>
...
$$Σ\vecτ_{(Γ)} = 0 \Rightarrow -τ_{Ν_Α} \cdot (AΓ) \cdot συνφ - Ν' \cdot x + W_ρ \cdot συνφ \cdot (ΚΓ) = 0 \Rightarrow -N_A \cdot 2.5 \frac{\sqrt3}{2} +20 \cdot \frac{\sqrt3}{2} \cdot \frac{1}{2} -20 \cdot \frac{\sqrt3}{2} \cdot x $$
...
$$Σ\vecτ_{(Γ)} = 0 \Rightarrow τ_{Ν_Α} \cdot (AΓ) \cdot συνφ + Ν' \cdot (ΟΓ) - W_ρ \cdot συνφ \cdot (ΚΓ) = 0$$

$$τ_{Ν_Α} \cdot (AΓ) \cdot συνφ + Μ_K \cdot g \cdot συνφ \cdot (ΟΓ) - Μ_ρ \cdot g \cdot συνφ \cdot (ΚΓ) \Rightarrow N_A \cdot (ΑΓ) = M_ρ \cdot g \cdot (ΚΓ) - Μ_Κ \cdot g \cdot (ΟΓ)$$
