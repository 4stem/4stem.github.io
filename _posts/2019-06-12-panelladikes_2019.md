...
ροπή του βάρους του κυλίνδρου στρέφουν την σανίδα αριστερόστροφα.
...
Όπου $$τ_{W_Σ}$$ είναι η ροπή του βάρους της σανίδας και $$τ_{N'}$$ είναι η ροπή της αντίδρασης του κυλίνδρου στην δράση $$Ν$$ της σανίδας στον κύλινδρο. 
Θα χρησιμοποιήσουμε διπλές συνεπαγωγές

$$τ_{W_Σ} > τ_{N'} \iff  Μ_ρ \cdot g \cdot συνφ \cdot (ΚΓ) > Μ_k \cdot g \cdot συνφ \cdot (x - x_Γ) $$

$$(ΚΓ) > (x - x_Γ) \iff 0.5 > υ_Γ \cdot (t - t_Γ) + \frac{1}{2} \cdot a_{cm} \cdot (t - t_Γ)^2 - 0,2 $$

και μετά τις πράξεις φτάνουμε στην ανίσωση 

$$t^2 - \frac{4 \cdot \sqrt5}{5} \cdot t - 1.3 <0$$
...
$$(ΚΓ) > (x - x_1) \iff 0.5 > υ_{cm1} \cdot (t - t_1) - \frac{1}{2} \cdot a_{cm} \cdot (t - t_1)^2 - 0,25 $$
