...
$$ω_1 = α_{γων_Κ} \cdot t_1 \Rightarrow ω_1 = \frac{1}{Ρ_Κ} \frac{rad}{s} $$
...
$$ημφ = \frac{h}{Δ_{x_{cm}}} \Rightarrow Δ_{x_{cm}} = 0.15m$$
...
Για να μην χάνεται η επαφή πρέπει $$N_Α \geqslant 0 \Rightarrow x \leq 0.5 m$$ δηλαδή για να μην ανατραπεί η σανίδα πρέπει ο κύλινδρος να φτάσει μέχρι $$0,5m$$ δεξιά του σημείου $$Γ$$.
