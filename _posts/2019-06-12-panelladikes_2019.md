...
$$  (ΘΙ_{m_1, m_2}) \quad Σ \vec{F} = 0 \Rightarrow \\ F'_{ελ} = (m_1 + m_2) \cdot g $$

$$ k \cdot Δl_1 = (m_1 + m_2) \cdot g \Rightarrow \\ Δl_1 = \frac{(m_1 + m_2) \cdot g}{k} \Rightarrow \\  Δl_1 = 0.1 m$$
...
Μια λάθος λύση για το $$Δ5$$ [εδώ](https://www.youtube.com/watch?v=el4RODNbpco) μετά το 29:30.
