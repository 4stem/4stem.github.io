...
Στον κάθετο στην σανίδα άξονα η συνισταμένη των δυνάμεων που ασκούνται στον κύλινδρο είναι μηδέν, οπότε $$Ν’ = Μ_κ \cdot g \cdot συνφ$$ 
...
δηλαδή για να ανατραπεί η σανίδα πρέπει ο κύλινδρος να φτάσει μέχρι $$0,5m$$ δεξιά του σημείου $$Γ$$.
