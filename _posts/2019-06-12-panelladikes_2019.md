...
$$Ι_{Κ(Δ)} = Ι_{cm} + M_Κ \cdot R_K^2 \Rightarrow Ι_{Κ(Δ)} = \frac{3}{2} \cdot M_K \cdot R_K^2$$
...
$$Σ\vecτ_{(Γ)} = τ_N' - τ_{W_ρ} \Rightarrow Ν' Σ\vecτ_{(Γ)} = \cdot (ΟΓ) - W_ρ \cdot συνφ \cdot (ΚΓ) $$
...
$$Σ\vecτ_{(Γ)} = τ_N' + τ_{W_ρ} = 2 \sqrt3 - 5 \sqrt3 \Rightarrow Σ\vecτ_{(Γ)} < 0$$

Αυτό σημαίνει ότι η ράβδος θα περιστραφεί με φορά αντίθετη από αυτή την ρολογιών, δηλαδή θα ασκεί δύναμη στο δάπεδο, δηλαδή $$Ν>0$$

Άρα άτοπο. Υποθέσαμε στην αρχή ότι η σανίδα ανατρέπεται δηλαδή $$Ν=0$$ και οδηγηθήκαμε στο ότι $$Ν>0$$ άρα η αρχική μας υπόθεση είναι εσφαλμένη.
