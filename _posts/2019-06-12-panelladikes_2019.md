...
H ανίσωση αληθεύει από την χρονική στιγμή $$t = t_Γ = \frac{\sqrt5}{5} s$$ έως την χρονική στιγμή $$t=t_1=0.5 s$$ 
...
$$|τ_{W_Σ}| > |τ_{N'}| \iff  Μ_ρ \cdot g \cdot συνφ \cdot (ΚΓ) > Μ_k \cdot g \cdot συνφ \cdot (x - x_1) $$

$$(ΚΓ) > (x - x_1) \iff 0.5 > υ_{cm1} \cdot (t - t_1) - \frac{1}{2} \cdot a_{cm} \cdot (t - t_1)^2 $$

και μετά τις πράξεις φτάνουμε στην ανίσωση 

$$5t^2 - 8 \cdot t - 1.75 < 0$$

H ανίσωση αληθεύει από την χρονική στιγμή $$t = t_1 = 0.5 s$$ έως την χρονική στιγμή $$t=t_2=0.8 s$$ 
