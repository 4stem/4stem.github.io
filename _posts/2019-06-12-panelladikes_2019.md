...
Για να μην χάνεται η επαφή πρέπει $$N_Α \geqslant 0 \Rightarrow \frac{10-20\cdot x}{2.5} \geqslant 0 \Rightarrow -20\cdot x \geqslant -10 \Rightarrow  x \leq 0.5 m$$ δηλαδή για να μην ανατραπεί η σανίδα πρέπει ο κύλινδρος να φτάσει μέχρι $$0,5m$$ δεξιά του σημείου $$Γ$$.
...
Έστω ότι την χρονική στιγμή $$t_2$$, δηλαδή την στιγμή που ο κύλινδρος στιγμιαία ισορροπεί, η σανίδα ανατρέπεται. Αυτό σημαίνει ότι η σανίδα δεν είναι
