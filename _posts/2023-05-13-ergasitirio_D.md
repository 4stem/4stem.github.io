...
**ΑΠΑΡΑΙΤΗΤΑ ΟΡΓΑΝΑ**
    ...
    2. Κατάλληλο σωληνοειδές (μεταλλικό βαρύ, συνοδεύει τον καθοδικό σωλήνα)
    3. Λάστιχο στερέωσης (συνοδεύουν την αγορά από λαϊκή χάρτινης αυγοθήκης)
...
**ΒΗΜΑ 2ο**
    ...
    1. Συνδέουμε κατ’ αρχήν (μόνο) τον κόκκινο ακροδέκτη των πλακιδίων
    οριζόντιας απόκλισης x'x στον θετικό ακροδέκτη της εξόδου ±5V DC 
    του τροφοδοτικού. 
    2. Καλούμε τον επιβλέποντα για έλεγχο.
    3. Θέτουμε σε λειτουργία το τροφοδοτικό (διακόπτης Ο/Ι) 
    και την ανοδική τάση στα 240V.
    Παρατηρούμε ότι η κηλίδα εκτρέπεται από το κέντρο
    $Ο$ του διαγραμμισμένου δίσκου και σχηματίζει μια γραμμή.
    4. Στρέφουμε τον διαγραμμισμένο δίσκο, που βρίσκεται μπροστά στην οθόνη,
    ώστε ο άξονας x'x να ταυτιστεί με τη γραμμή.
    ΠΡΟΣΟΧΗ : περιστρέφουμε μόνο τον διαγραμμισμένο δίσκο και όχι ολόκληρο
    τον καθοδικό σωλήνα! 
...
**ΒΗΜΑ 3ο**
    ...
    1. Συνδέουμε κατόπιν και τον μαύρο ακροδέκτη των πλακιδίων x'x στον 
    αρνητικό ακροδέκτη της εξόδου ±5V DC του τροφοδοτικού. 
    2. Καλούμε τον επιβλέποντα για έλεγχο.
    3. Θέτουμε σε λειτουργία το τροφοδοτικό (διακόπτης Ο/Ι) 
    και την ανοδική τάση στα 240V.
    Παρατηρούμε ότι η κηλίδα μετακινείται από την αρχική θέση Ο σε μία νέα θέση Α1. 
    Περιστρέφουμε το διαγραμμισμένο δίσκο (όχι τον καθοδικό σωλήνα), ώστε 
    ο άξονας x'x να περνάει από το σημείο Α1.
    ΠΑΡΑΤΗΡΗΣΗ : ο άξονας x'x του διαγραμμισμένου δίσκου στη θέση αυτή 
    δεν είναι απαραίτητα οριζόντιος. 
...
**ΜΕΤΡΗΣΕΙΣ**
    ...
    ξεκινώντας από το σημείο Α1 του άξονα x'x, τείνει να 
    διαγράψει στην οθόνη μία σχεδόν κυκλική δεξιόστροφη τροχιά 
    για ένα μόνο τεταρτημόριο του κύκλου μέχρι το σημείο Α2 
    του άξονα y'y, όπως φαίνεται στο σχήμα:
...
![σχήμα]({{ site.url }}/assets/ergas2.png) 
    ...
    7. Επαναλαμβάνουμε τα στάδια 5 και 6 για διαφορετικές ανοδικές τάσεις
    και συμπληρώνουμε κατάλληλο πίνακα.
