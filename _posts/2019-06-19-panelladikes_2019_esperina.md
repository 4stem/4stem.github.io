---
layout: post
title: "Μοριοδότηση 2019 - Εσπερινά"
...
$$f = \frac{N}{t} = \frac{30}{30} = 1 Hz \Rightarrow T = \frac{1}{f} = 1 s$$

$$ω = \frac{2π}{T} \Rightarrow ω = 2π \frac{rad}{s}$$

$$2 A = 0.2 \Rightarrow A = 0.1 m$$

$$x_Γ = υ_δ \cdot t \Rightarrow x_Γ = υ_δ \cdot 2 T \Rightarrow υ_δ = 0.2 \frac{m}{s}$$

$$\frac{υ_{max}}{υ_δ} = \frac{A\cdot ω}{υ_δ} = \frac{0.2π}{0.2} = π$$
...
![σχήμα]({{ site.url }}/assets/b3_ropi_esperina.png) 
...
$$ΔΕ_Μ = Ε_Μ^{αρχ} - Ε_Μ^{τελ} = Κ_{αρχ} - Κ_{τελ} = \frac{1}{2} \cdot m_2 \cdot u_o^2 - \frac{1}{2} \cdot (m_1 + m_2) \cdot V_K^2 $$

$$ΔΕ_Μ = 1.5 - 0.75 \Rightarrow ΔΕ_Μ = 0.75 J$$
...
$$α_{cm} = \frac{α_Σ}{2} \Rightarrow α_{cm} = 2 \frac{m}{s^2}$$


**Δ3**-$$(7)$$

$$T_4 + T_{στ} - 10 = 2\cdot α_{cm} \Rightarrow T_4 + T_{στ} =14 \quad (1)$$

$$T_4 - T_{στ} =  α_{cm} \Rightarrow T_4 - T_{στ} = 2 \quad (2) $$

Λύση του συστήματος $$Τ_4 = 8Ν, \quad Τ_{στατ} = 6Ν$$
