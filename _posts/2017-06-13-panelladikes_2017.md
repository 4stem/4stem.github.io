...
$$\begin{matrix}y_Ρ=0,4m=A y_Ρ=Aημφ_Ρ\end{matrix} \right} ημφ_Ρ=1\implies φ_Ρ=2k\pi+\frac{\pi}{2},k=0,1,2,\ldots $$
...
$$ \left. \begin{matrix}ΣF=m\cdot a\_{cm}\implies W-T_1=m\cdot a_{cm} \\\ Σ τ=Iα_{γων}\implies T_1\cdot R=\frac{1}{2}mR^2\cdot α\_{γων}\end{matrix} \right\\} \\\ T_1=\frac{m\cdot a_{cm}}{2},W=\frac{3m\cdot a_{cm}}{2} $$
