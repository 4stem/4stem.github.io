...
$$ P_B + \frac{1}{2}ρv_Β^2+ρgH=P_Γ+\frac{1}{2}ρv_Γ^2+ρgh\overset{P_Β=P_Γ=P_{at}}{\underset{v_Β=0}{\Rightarrow}} \\\      ρg5h=\frac{1}{2}ρv_Γ^2+ρgh\Rightarrow v_Γ^2=8gh\Rightarrow v_Γ=2\sqrt{2gh}$$
...
$$\left\begin{matrix}y_Ρ=0,4m=A y_Ρ=Aημφ_Ρ\end{matrix} \right} ημφ_Ρ=1\Rightarrow φ_Ρ=2k\pi+\frac{\pi}{2},k=0,1,2,\ldots $$
