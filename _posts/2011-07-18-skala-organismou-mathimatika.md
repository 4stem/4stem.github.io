...
Επειδή η κίνηση του άκρου $$Α$$ είναι επιταχυνόμενη κατακόρυφη κίνηση βγάζουμε το συμπέρασμα ότι η συνολική οριζόντια επιτάχυνση θα πρέπει να είναι μηδέν, δηλαδή:

$$α_{γων} \cdot \frac{L}{2} \cdot ημθ = α_{xcm}$$

Ανάλογα ισχύουν και για την κίνηση του άκρου $$Β$$ της ράβδου, μόνο που λόγω της επιταχυνόμενης οριζόντιας κίνησής του βγάζουμε το συμπέρασμα ότι η συνολική κατακόρυφη επιτάχυνση θα πρέπει να είναι μηδέν, δηλαδή:
...
και κάνοντας αρκετές πράξεις, αφού χρησιμοποιήσουμε και την ταυτότητα $$ημ^2θ+συν^2θ = 1$$ έχουμε:
...
$$α_{ycm} = \frac{12.5 \sqrt{13.75}{6} \frac{m}{s^2}$$
