...
Μία σκάλα μήκους $$L = 3m$$ είναι τοποθετημένη σ' έναν τοίχο. Το κάτω μέρος της σκάλας γλυστράει στο δάπεδο με ρυθμό $$0.1 \frac{m}{s}$$. Τη χρονική στιγμή  $$t_0$$ , που η κορυφή της σκάλας απέχει από το δάπεδο $$2.5m$$, να βρείτε:
