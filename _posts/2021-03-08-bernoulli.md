...
όπως φαίνεται στο παραπάνω σχήμα. Θα εξετάσουμε την πίεση σε δύο σημεία $$Β, \quad Γ$$, 
...
το ρευστό που θεωρούμε ως σύστημα προς το δεξιά περιβάλλον ρευστό μπορούμε να την σκεφτόμαστε 
και σαν δύναμη ανά μονάδα επιφάνειας αλλά και σαν πυκνότητα ροής ενέργειας, δηλαδή σαν ενέργεια
...
$$\frac{ΔΚ}{ΔV}>0$$ πότε η μεταβολή της δυναμικής πίεσης είναι θετική ή με απλά λόγια πότε η κινητική ενέργεια
...
$$\frac{ΔΚ}{ΔV}<0$$ πότε η μεταβολή της δυναμικής πίεση είναι αρνητική ή με απλά λόγια πότε η κινητική ενέργεια
...
$$\frac{ΔU}{ΔV}>0$$ πότε η μεταβολή της υψομετρικής πίεσης είναι θετική ή με απλά λόγια πότε η δυναμική ενέργεια
ανά μονάδα όγκου είναι θετική. Όταν το ρευστό (αυτό που θεωρούμε σύστημα) ανέρχεται σε κάποιον αγωγό. Τότε
η τελική βαρυτική δυναμική ενέργεια είναι μεγαλύτερη από την αρχική και αυτό σημαίνει ότι η αυξάνεται
...
$$\frac{ΔU}{ΔV}<0$$ πότε η μεταβολή της υψομετρικής πίεσης είναι αρνητική ή με απλά λόγια πότε η δυναμική ενέργεια
ανά μονάδα όγκου είναι αρνητική. Όταν το ρευστό (αυτό που θεωρούμε σύστημα) κατέρχεται σε κάποιον αγωγό. Τότε
η τελική βαρυτική δυναμική ενέργεια είναι μικρότερη από την αρχική και αυτό σημαίνει ότι η ελαττώνεται
το υψόμετρο $$h$$ και αυτό έχει σαν συνέπεια να ελαττώνεται η πυκνότητα ροής δυναμικής ενέργειας δηλαδή
η δυναμική ενέργεια ανά μονάδα όγκου.

$$Δp>0$$ πότε η μεταβολή της στατικής πίεσης είναι θετική ή με απλά λόγια πότε το έργο του περιβάλλοντος 
...
$$Δp<0$$ πότε η μεταβολή της στατικής πίεσης είναι αρνητική ή με απλά λόγια πότε το έργο του περιβάλλοντος 
