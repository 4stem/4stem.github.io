...
description: "Διαδραστική 3D προσομοίωση του πειράματος Stern–Gerlach"
category: Εφαρμογή
tags: [Κβαντομηχανική]
---

# Διαδραστική Προσομοίωση Stern–Gerlach

Τρισδιάστατη προσομοίωση του ιστορικού πειράματος Stern–Gerlach (1922) για την διδασκαλία της **κβάντωσης της στροφορμής** στη Φυσική Γʹ Λυκείου.
...
- ✅ Orbit camera (drag ποντικιού / zoom scroll)
- ✅ Δυναμικές γραμμές πεδίου με βέλη φοράς (κλιμακώνονται με ∂B/∂z)
...
<style>
#sg3d-app * { box-sizing: border-box; margin: 0; padding: 0; }
#sg3d-app {
  width: calc(100% + 40px);
  margin: -20px;
  height: 150vh;
...
#sg3d-app{--bg:#070b14;--panel:#0f1525;--brd:#1a2840;--acc:#00c8ff;--gold:#ffd166;--grn:#06d6a0;--mag:#d55aff;--org:#ff6b35;--txt:#c8d8f0;--dim:#6a80a0}
*{box-sizing:border-box;margin:0;padding:0}
#sg3d-app-inner{background:var(--bg);color:var(--txt);font-family:Arial,sans-serif;display:flex;flex-direction:column}
#sg3d-app header{background:#0a1020;border-bottom:1px solid var(--brd);padding:7px 16px;display:flex;align-items:center;gap:10px;flex-shrink:0}
#sg3d-app header h1{font-size:15px;font-weight:700;color:var(--acc);letter-spacing:1px}
#sg3d-app header h1 span{color:var(--dim);font-weight:400;font-size:10px;display:block}
#sg3d-app .main{display:flex;flex-direction:column;flex:1;min-height:0;overflow:hidden}
.top-row{display:grid;grid-template-columns:1fr 1fr;flex-shrink:0;border-bottom:1px solid var(--brd)}
#sg3d-app .panel{background:var(--panel);padding:9px 11px;overflow-y:auto;display:flex;flex-direction:column;gap:7px;font-size:12px;max-height:20vh}
.L{border-right:1px solid var(--brd)}
...
#sg3d-app .ctr{position:relative;display:flex;flex-direction:column;overflow:hidden;flex:1;min-height:400px}
...
<div class="main">
<table style="width:100%;table-layout:fixed;border-collapse:collapse;border-bottom:1px solid #1a2840;"><tbody><tr>
<td style="width:50%;vertical-align:top;padding:9px 11px;background:#0f1525;border-right:1px solid #1a2840;overflow-y:auto;max-height:20vh;">
...
<td style="width:50%;vertical-align:top;padding:9px 11px;background:#0f1525;overflow-y:auto;max-height:20vh;">
